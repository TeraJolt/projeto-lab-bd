...
<form method="POST">
    ...
    <div class="formulario">
        <label>Nome<input type="text" maxlength="100" name="nome" value="<?php echo $row['nome']; ?>"></label>
        <label>Endereco<input type="text" maxlength="100" name="endereco" value="<?php echo $row['endereco']; ?>"></label>
        <label>Número<input type="text" maxlength="10" name="numero" value="<?php echo $row['numero']; ?>"></label>
        <label>Bairro<input type="text" maxlength="100" name="bairro" value="<?php echo $row['bairro']; ?>"></label>
        <label>Cidade<input type="text" maxlength="100" name="cidade" value="<?php echo $row['cidade']; ?>"></label>               
        <label>Estado
        <select name="estado">   
        ...
        <label>Email<input type="email" maxlength="100" name="email" value="<?php echo $row['email']; ?>"></label>
        <label>CPF/CNPJ<input type="text" maxlength="14" name="cpf_cnpj" value="<?php echo $row['cpf_cnpj']; ?>"></label>
        <label>RG<input type="text" maxlength="9" name="rg" value="<?php echo $row['rg']; ?>"></label>
        <label>Telefone<input type="text" maxlength="10" name="telefone" value="<?php echo $row['telefone']; ?>"></label>
        <label>Celular<input type="text" maxlength="11" name="celular" value="<?php echo $row['celular']; ?>"></label>
        <label>Data de Nascimento<input type="date" name="data_nasc" value="<?php echo $row['data_nasc']; ?>"></label>
        <label>Salário<input type="number" step="200" name="salario" value="<?php echo $row['salario']; ?>"></label>
    </div>
    <div class="botoes">
